      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="bg-white rounded-xl shadow-lg p-8">
          ...
          <div className="prose max-w-none">
            ...
            <p className="text-gray-600 mb-6">
              By accessing or using Chillings Entertainment, you agree to be bound by these Terms of Service and all applicable laws and regulations.
            </p>
            ...
            <h2 className="text-2xl font-bold text-gray-900 mt-8 mb-4">Event Organizers</h2>
            <p className="text-gray-600 mb-6">
              Event organizers are responsible for the accuracy of event information, compliance with local laws, and fulfillment of services promised to attendees.
            </p>

            <h2 className="text-2xl font-bold text-gray-900 mt-8 mb-4">Vendors</h2>
            <p className="text-gray-600 mb-6">
              Vendors are responsible for delivering services as described, maintaining appropriate licenses and insurance, and complying with all applicable regulations.
            </p>

            <h2 className="text-2xl font-bold text-gray-900 mt-8 mb-4">Limitation of Liability</h2>
            <p className="text-gray-600 mb-6">
              Chillings Entertainment acts as a platform connecting event organizers and vendors. We are not responsible for the quality, safety, or legality of events or services provided by third parties.
            </p>
